        ...
        >
          ...
          <div className="px-4 bg-white flex flex-col gap-1 z-10">
            ...
            <button
              ...
              className="w-full py-1.5 rounded-md mt-3 font-titleFont font-medium text-base bg-gradient-to-tr from-blue-400 to-blue-200 border border-blue-500 hover:border-blue-700 hover:from-blue-300 to hover:to-blue-400 active:bg-gradient-to-bl active:from-blue-400 active:to-blue-500 duration-200"
            >
              Add to Cart
            </button>
          </div>
